...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] {"CSE","DS","AI","CIVIL","MECH" };
	private String[] yearString = new String[] {"SY","TY","BE"};
	private String[] subjectSEString = new String[] {"DS","M3"};
	private String[] subjectTEString = new String[] {"AA","CN"};
	private String[] subjectBEString = new String[] {"DC","DL"};

	private String[] subjectFinal = new String[] {"M3","DS","AA","CN","DL","DC"};
